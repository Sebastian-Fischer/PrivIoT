...
//    }
    ...
    private void registerPrivIoTView() throws Exception{
        URI uri = new URI(null, null, null, -1, "/services/geo-views/priviot-view", null, null);

        LocalServerChannel localChannel = this.localChannelFactory.newChannel(
                this.internalPipelineFactory.getPipeline()
        );

        HttpWebservice httpWebservice = new PrivIoTView(
                this.ioExecutor, this.internalTasksExecutor
        );
