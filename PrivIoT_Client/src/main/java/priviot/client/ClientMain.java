...
public class ClientMain {
	...
	private static final int SENSOR_UPDATE_INTERVAL = 15;
	private static final String SSP_HTTP_URI = "http://localhost";
	...
	private static void startController() {
	    Controller controller = new Controller(SENSOR_URI, SENSOR_SECRET, SENSOR_UPDATE_INTERVAL, SSP_HTTP_URI, SSP_HTTP_PORT);
